				...
				<div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
					...
					<div class="card shadow-lg">
						<div class="card-body p-5">
							...
							<?php echo form_open('User/registrar_form'); ?>
                                <div class="mb-3">
									<input type="hidden" name="id" id="id" value="<?= $this->input->get('id') ? $this->input->get('id'):''?>">  
									<label class="mb-2 text-muted" for="email">Nome Completo</label>
									<input type="text" id="nome" name="nome" class="form-control" placeholder="Nome" value="" required autofocus>
									
								</div>
								<div class="mb-3">
									<label class="mb-2 text-muted" for="email">E-mail</label>
									<input id="email" type="email" name="email" class="form-control" placeholder="exemplo@email.com" value="" required autofocus>
                                ...
                                <div class="mb-3">
                                    ...
                                    <label class="mb-2 text-muted" for="password">Confirme a senha</label>
									<input id="senha" type="password" name="conf_senha" class="form-control"  required>
						...
						<div class="card-footer py-3 border-0">
							<div class="text-center">
								Possui uma conta ? <a href="<?php echo site_url();?>User" class="text-dark"> Login</a>
							</div>
						</div>
					</div>
